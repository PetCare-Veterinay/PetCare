...
@section('content')
    ...
    <div class="content" style="background-color: #fff; border: 2px solid #fff; padding: 35px;">
        ...
        <div class="d-flex justify-content-between mb-3">
            ...
            <a href="{{ route('Nuevo') }}" id="load-create-view" class="btn btn-primary large_button"> + Agregar</a>
        </div>
        <!-- Lista de Datos -->
        <div class="box">
            <div class="box-body">
...
fetch('/api/servicio')
        ...
        .then(data => {
            ...
            data.forEach(user => {
                ...
                const id = user.id;
                window.location.href = `/2servicio/${user.id}`; 
                });
                ...
                deleteButton.setAttribute('data-delete', `api/servicio/${user.id}`);
